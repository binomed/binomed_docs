...
<!-- .slide: data-background="assets/images/Google-I_O.png" data-state="hidefooter" class="transition" -->
...
![center h-600](assets/images/Android-L-Lockscreen-PIN.png)
...
![center h-600](assets/images/android_chrome_shortcuts.png)
